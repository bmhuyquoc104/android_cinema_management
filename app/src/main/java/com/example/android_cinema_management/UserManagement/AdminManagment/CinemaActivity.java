...
public class CinemaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout = findViewById(R.id.admin_cinema_tabLayout);
        viewpager2 = findViewById(R.id.admin_cinema_viewpager2);
        close = findViewById(R.id.admin_cinema_close_iv);
        // Initialize fragment manager
        FragmentManager fm = getSupportFragmentManager();
        // Initialize adapter
        adapter = new CinemaFragmentAdapter(fm,getLifecycle());
