...
public class ComboActivity extends AppCompatActivity {
    ...
    ComboAdminFragmentAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewpager2 = findViewById(R.id.admin_combo_viewpager2);
        close = findViewById(R.id.admin_combo_close_iv);
        // Initialize fragment manager
        FragmentManager fm = getSupportFragmentManager();
        // Initialize adapter
        adapter = new ComboAdminFragmentAdapter(fm,getLifecycle());
