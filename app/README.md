...
1. Project's title: "Cinema Management Application"
...
- Users:
    ...
    + logout
    + forgot password
    + add review for any movies
    + write feedback for ticket for any cinemas available.
    + make transactions to buy ticket for any movies at any cinemas available.
    + Use point after buying movies tickets to exchange combo.
    + Buy vouchers.
- Admin:
...
- User account can be register by pressing account button from bottom nav and choose register or use these following account that has been registered.
    + Username: truongan1730@gmail.com
    + Password: 123123

8. App's drawback
- Our app could be a bit laggy when accessing for database. Because we enormous date being store in our database.
- We can not find any available api for movie tickets. Therefore, that app is not fully optimize when working with movie tickets.
